...
public class APIURL {
   ...
   // public static final String main_url="https://e05a-69-160-8-61.ngrok-free.app";
    public static final String main_url="https://api.9-9.chat/";
    public static final String DomainName=main_url;
    public static final String ImageUrl=main_url;
    public static final String check_phone="v1/api/user/check/phone/";
    public static final String check_otp="v1/api/user/checkeOTP/";
    public static final String register="v1/api/user/register";
