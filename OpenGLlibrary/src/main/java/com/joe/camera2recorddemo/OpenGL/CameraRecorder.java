...
public class CameraRecorder {
    ...
    private final int mRecordSampleRate = 48000;// 音频采样率
    private final int mRecordChannelConfig = AudioFormat.CHANNEL_IN_STEREO;// 音频录制通道,默认为立体声
    private final int mRecordAudioFormat = AudioFormat.ENCODING_PCM_16BIT; // 音频录制格式，默认为PCM16Bit
    private SurfaceTexture mInputTexture;
    private Surface mOutputSurface;
    private Surface mEncodeSurface;
    private final EGLHelper mShowEGLHelper;
    private Configuration mConfig;
    private String mOutputPath;
    private final MediaCodec.BufferInfo mAudioEncodeBufferInfo;
    private final MediaCodec.BufferInfo mVideoEncodeBufferInfo;
    ...
    private final Runnable mGLRunnable = new Runnable() {
        @Override
        public void run() {
